...
<html>
    <head>
        ...
        <style>.barrenom .BarreMenuGraph{color:#00aaff} .barrenom2 .BarreMenuGraph{color:#00aaff}</style>
                ...
                while($donnees = $reponse->fetch()){?>
                    <div>
                        ...
                        <?php if($_SESSION['auth']->id == '19'){
                            ?>
                            <a href="graph.php"><img class="suppr" src="Images/suppr.png" alt="Image suppression" title="Supprimer le fichier '<?php echo $donnees['nomfichier']; ?>'"></a>
                            <?php
                        }
