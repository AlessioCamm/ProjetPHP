...
<html>
    <head>
        ...
        <title>Développement | <?= $_SESSION['auth']->prenom; ?></title>
        <link rel="stylesheet" href="style.css" />
        <style>.barrenom .BarreMenuDev{color:#00aaff} .barrenom2 .BarreMenuDev{color: #000000; background-color: #ff8d4e; border-radius: 5px;}</style>
        ...
        <div class="fenetrePerso">
            ...
            <form method="post" enctype="multipart/form-data" class="fenetrePersoUpload">
                ...
                <select name="choixCat">
                    ...
                    <option value="Développement" selected="selected">Développement</option>
                    <option value="Electronique">Electronique</option>
                    <option value="Graphisme">Graphisme</option>s
                </select><br>
                <textarea name="commentaire" rows="8" cols="20" maxlength="200" placeholder="Fichier de max 25 Mo, catégorie 'Développement' par défaut, commentaire optionnel de 200 caractères. Plus d'infos dans l'onglet 'Gérer vos fichiers'."></textarea><br>
                ...
                while($donnees = $reponse->fetch()){?>
                    <div>
                        ...
                        <?php if($_SESSION['auth']->id == '19'){
                            ?>
                            <a href="dev.php?<?=$donnees['id_fichier']?>"><img class="suppr" src="Images/suppr.png" alt="Image suppression" title="Supprimer le fichier '<?php echo $donnees['nomfichier']; ?>'"></a>
                            <?php
                        }
                        ...
                        <img class="profil" src="<?php echo $donnees['photo_user']; ?>" alt="Image profil"><strong class="fileuser"><?php echo $donnees['prenom_user']; ?> <?php echo $donnees['nom_user']; ?></strong>, il y a <strong class="filedate"><?php include "Utile/afficheDateDiff.php"; ?></strong><br>
                        <hr>
