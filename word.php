...
<html>
    <head>
        ...
        <style>.barrenom .BarreMenuWord{color:#00aaff} .barrenom2 .BarreMenuWord{color: #000000; background-color: #ff8d4e; border-radius: 5px;}</style>
    ...
    <body>
        ...
        <div class="fenetrePerso">
            ...
            <form method="post" enctype="multipart/form-data" class="fenetrePersoUpload">
                ...
                <textarea name="commentaire" rows="8" cols="20" maxlength="200" placeholder="Fichier de max 25 Mo, catégorie 'Informatique' par défaut, commentaire optionnel de 200 caractères. Plus d'infos dans l'onglet 'Gérer vos fichiers'."></textarea><br>
                ...
                while($donnees = $reponse->fetch()){?>
                    <div>
                        ...
                        <?php if($_SESSION['auth']->id == '19'){
                            ?>
                            <a href="word.php?<?=$donnees['id_fichier']?>"><img class="suppr" src="Images/suppr.png" alt="Image suppression" title="Supprimer le fichier '<?php echo $donnees['nomfichier']; ?>'"></a>
                            <?php
                        }
